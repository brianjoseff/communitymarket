...
#         post :create, {:image => { "user_id" => "invalid value" }}, valid_session
#         assigns(:image).should be_a_new(Image)
#       end
# 
...
#         Image.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
#         put :update, {:id => image.to_param, :image => { "user_id" => "1" }}, valid_session
#       end
# 
#       it "assigns the requested image as @image" do
#         image = Image.create! valid_attributes
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Image.any_instance.stub(:save).and_return(false)
#         put :update, {:id => image.to_param, :image => { "user_id" => "invalid value" }}, valid_session
#         assigns(:image).should eq(image)
#       end
# 
