...
#         post :create, {:transaction => { "price" => "invalid value" }}, valid_session
#         assigns(:transaction).should be_a_new(Transaction)
#       end
# 
...
#         Transaction.any_instance.should_receive(:update_attributes).with({ "price" => "1" })
#         put :update, {:id => transaction.to_param, :transaction => { "price" => "1" }}, valid_session
#       end
# 
#       it "assigns the requested transaction as @transaction" do
#         transaction = Transaction.create! valid_attributes
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Transaction.any_instance.stub(:save).and_return(false)
#         put :update, {:id => transaction.to_param, :transaction => { "price" => "invalid value" }}, valid_session
#         assigns(:transaction).should eq(transaction)
#       end
# 
