class User < ActiveRecord::Base
  ...
  attr_accessible :email, :name,:password, :school_id, :password_confirmation, :current_password, :remember_me, :stripe_customer_id, :admin, :provider, :uid, :oauth_token, :oauth_expires_at, :auth_token
