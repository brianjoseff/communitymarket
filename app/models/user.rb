class User < ActiveRecord::Base
  ...
  attr_accessible :email, :name, :password, :password_confirmation, :current_password, :remember_me, :stripe_customer_id, :admin, :provider, :uid, :oauth_token, :oauth_expires_at, :phone, :super_seller
